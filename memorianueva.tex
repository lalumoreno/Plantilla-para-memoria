...
En la presente memoria se describe el diseño y la implementación de un sistema Bluetooth Mesh para la gestión de sensores en invernaderos. Este trabajo se realiza para la empresa Wentux Tecnoagro, con el fin de mejorar la escalabilidad y eficiencia de sus soluciones actuales.
